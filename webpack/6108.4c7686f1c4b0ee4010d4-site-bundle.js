/*! For license information please see 6108.4c7686f1c4b0ee4010d4-site-bundle.js.LICENSE.txt */
"use strict";
    ...
    [6108], {
        ...
        237872: function(e, t, a) {
            ...
            var De = d.Map({}),
                ...
                be = a(839658),
                Ue = a(387228),
                Je = (a(241539), a(339714), a(62462)),
                Ze = a.n(Je),
                we = a(439552),
                Ge = a(891743),
                Le = (0, a(462953).vV)("category/portfolio"),
                Be = Le.UPDATE_ENTITY_SUCCESS,
                xe = Le.DELETE_ENTITY_SUCCESS,
                ke = Be,
                He = xe,
                qe = d.Map({}),
                Ye = d.Map({}),
                ...
                Qe = (0, D.combineReducers)({
                    ...
                    paginatedProducts: function() {
                        var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Ve,
                            a = arguments.length > 1 ? arguments[1] : void 0;
                        switch (a.type) {
                            case we.on + we.FE:
                                return t.mergeDeep({
                            ...
                            case we.cx + we.FE:
                                return e = t.getIn(["products", a.meta.siteId], d.fromJS([])), t.setIn(["products", a.meta.siteId], c()(e).call(e, d.fromJS(a.payload.entities.product))).mergeDeep(d.fromJS({
                                    isFetching: !1,
                                    hasError: !1,
                                    paginationMeta: a.payload.paginationMeta || {}
                                }));
                            case we.hY + we.FE:
                                return t.setIn(["products", a.meta.siteId], d.fromJS(a.payload.entities.product || {})).mergeDeep(d.fromJS({
                                    isFetching: !1,
                                    fetchError: !1,
                                    paginationMeta: a.payload.paginationMeta || {}
                                }));
                            case we.uN + we.FE:
                                return a.meta.reloadProduct ? t : (e = t.getIn(["products", a.meta.siteId], d.fromJS([])), t.setIn(["products", a.meta.siteId], e.insert(a.payload.afterIndex, a.payload.productData).deleteIn([a.payload.beforeIndex])));
                            case we.zk + we.FE:
                                return e = t.getIn(["products", a.meta.siteId], d.fromJS([])), t.setIn(["products", a.meta.siteId, Ze()(e).call(e, (function(e) {
                                    return "".concat(e.get("id")) === "".concat(a.meta.productId)
                                }))], d.fromJS(a.payload.product));
                            case we.V9 + we.FE:
                            case we.WW + we.FE:
                                return e = t.getIn(["products", a.meta.siteId], d.fromJS([])), t.setIn(["products", a.meta.siteId], e.unshift(d.fromJS(a.payload.product)));
                            case we.lJ + we.FE:
                                return t.mergeDeep({
                                    isFetching: !1,
                                    fetchError: !0
                    ...
                    data: je,
                    list: function() {
                        var e, t, a, n, r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : We,
                ...
                (tt = (0, Fe.Z)()).addModule({
                    ...
                    reducerMap: r()({
                        ...
                        entities: (0, D.combineReducers)({
                            ...
                            product: Ue.default,
                            portfolioProduct: Qe,
                            category: (0, $e.createEntityReducer)("category/ecommerce"),
                            portfolioCategory: (0, $e.createEntityReducer)("category/portfolio"),
                            pageData: ze.default,
                            pageMeta: Ke.default,
