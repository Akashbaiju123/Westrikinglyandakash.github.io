/*! For license information please see 6764.6646575780ef867f8b09-site-bundle.js.LICENSE.txt */
        ...
        796764: function(o, e, g) {
            ...
            var m, i, w = g(54103),
                ...
                V = function() {
                    function o() {
                        var e, g, a, l, s, c;
                        (0, r.default)(this, o), this.logPageView = (0, n.default)(e = this.logPageView).call(e, this), this.logSocialClicks = (0, n.default)(g = this.logSocialClicks).call(g, this), this.normalizedReferrer = (0, n.default)(a = this.normalizedReferrer).call(a, this), this.sendPbsImpression = (0, n.default)(l = this.sendPbsImpression).call(l, this), this.sendPbsConversion = (0, n.default)(s = this.sendPbsConversion).call(s, this), this.sendDataKeenIO = (0, n.default)(c = this.sendDataKeenIO).call(c, this)
                    }
                    return (0, t.default)(o, [{
                        key: "init",
                        value: function(o) {
                            var e, g;
                            return j.cookie("__strk_session_id") ? (g = j.cookie("__strk_session_id"), e = !0) : (g = "visotor-xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g, (function(o) {
                                var e = 16 * Math.random() | 0;
                                return ("x" === o ? e : 3 & e | 8).toString(16)
                            })), e = !1, j.cookie("__strk_session_id", g, {
                                expires: 365,
                                path: "/"
                            })), this.visitorGeoInfo = {}, j.cookie("__strk_viewer_info") && (this.visitorGeoInfo = JSON.parse(atob(j.cookie("__strk_viewer_info")))), this.browserData = {
                                keen: {
                                    addons: [{
                                        name: "keen:ip_to_geo",
                                        input: {
                                ...
                                pageId: P.getId(),
                                userId: P.getUser().get("id"),
                                permalink: P.getPermalink(),
                                membership: P.getUser().get("membership"),
                                createdAt: P.getCreatedAt(),
                                strikinglyBranding: P.getShowStrikinglyLogo()
                            }, this.baseData = G.extend(this.baseData, {
                                visitorId: g,
                                isReturnVisit: e,
                                sessionId: g,
                                referrer: document.referrer,
                                utm_params: j.cookie("__uniq_utm_config") ? JSON.parse(j.cookie("__uniq_utm_config")) : {}
                            }), T.getIsBlog() ? this._internals = {
                                user: {
                                    id: P.getUserId(),
                                ...
                                page: {
                                    ...
                                    googleAnalyticsTracker: P.getGoogleAnalyticsTracker(),
                                    googleAnalyticsType: P.getGoogleAnalyticsType(),
                                    facebookPixelId: P.getFacebookPixelId()
                                }
                            } : this._internals = {
                                user: {
                                    id: P.getUser().get("id"),
                                ...
                                page: {
                                    ...
                                    theme: P.getTheme().get("name"),
                                    strk_upvt: P.getStrkUpvt(),
                                    strkGaTracker: P.getStrkGaTracker(),
                                    googleAnalyticsTracker: P.getGoogleAnalyticsTracker(),
                                    googleAnalyticsType: P.getGoogleAnalyticsType(),
                                    facebookPixelId: P.getFacebookPixelId()
                                }
                            }, C.traverseObj(this._internals, (function(o) {
                                for (var e in o) {
                                    var g = o[e];
                                    G.isUndefined(g) && console.warn("".concat(e, " is undefned"))
                                }
                            })), this.strikinglyGoogleAnalyticsEnabled = T.isGoogleAnalyticsEnabled(), this.strikinglyKeenAnalyticsEnabled = T.isKeenAnalyticsEnabled(), this.setupGA(), this.setupFB()
                        }
                    }, {
                        key: "setSocialShareTracking",
                        value: function() {
                            var o = this;
                            return U.Event.subscribe("Site.facebook.edge.create", (function() {
                                return o.trackSocialMediaShare("facebook", "like")
                            })), U.Event.subscribe("Site.linkedin.share", (function() {
                                return o.trackSocialMediaShare("linkedin", "share")
                            })), U.Event.subscribe("Site.twitter.tweet", (function() {
                                return o.trackSocialMediaShare("twitter", "tweet")
                            })), U.Event.subscribe("Site.gplus.plusone", (function() {
                        ...
                        key: "setupGA",
                        value: function() {
                            this.strikinglyGoogleAnalyticsEnabled && (O.log("[GA] Setup internal GA: ", this._internals.page.strkGaTracker), "function" == typeof __ga && (__ga("create", this._internals.page.strkGaTracker, {
                                name: "strk",
                                cookieDomain: "auto"
                            }), __ga("strk.set", "anonymizeIp", !0))), this.userGoogleAnalyticsEnabled() && (O.log("[GA] Setup GA for user: ", this._internals.page.googleAnalyticsTracker), this.userUniversalAnalyticsEnabled() ? (O.log("[GA] Initialize Universal Analytics"), window.ga = __ga, "function" == typeof ga && (ga("create", this._internals.page.googleAnalyticsTracker, "auto"), ga("set", "anonymizeIp", !0))) : (O.log("[GA] Initialize Classic Analytics"), E.push(["_setAccount", this._internals.page.googleAnalyticsTracker]), E.push(["_gat._anonymizeIp"])))
                        }
                    }, {
                        key: "setupFB",
                        value: function() {
                            if (this._internals.page.facebookPixelId && !this._fbPixelLoaded) return window._strk_fbq || B.loadFB(), window._strk_fbq("init", this._internals.page.facebookPixelId), this._fbPixelLoaded = !0, this._fbPixelLoaded
                        }
                    }, {
                        key: "trackPageViewOnGA",
                        value: function(o) {
                            if (this.strikinglyGoogleAnalyticsEnabled && (O.log("[GA] Send page view to internal GA"), "function" == typeof __ga && __ga("strk.send", "pageview", {
                                    anonymizeIp: !0
                                })), this.userGoogleAnalyticsEnabled())
                                if (o && (o += location.search || ""), this.userUniversalAnalyticsEnabled()) O.log("[GA] Send page view to user GA (Universal)"), o && "function" == typeof ga && ga("set", "page", o), "function" == typeof ga && ga("send", "pageview", {
                                    anonymizeIp: !0
                                });
                                else {
                                    O.log("[GA] Send page view to user GA (Classic)");
                        ...
                        value: function(o, e) {
                            ...
                            if (this.strikinglyGoogleAnalyticsEnabled && (O.log("[GA] Send page event to internal GA: ", o, e, g, a), "function" == typeof __ga && __ga("strk.send", "event", o, e, g, a, {
                                    anonymizeIp: !0
                                })), this.userGoogleAnalyticsEnabled())
                                if (this.userUniversalAnalyticsEnabled()) O.log("[GA] Send page event to user GA (Universal)"), "function" == typeof ga && ga("send", "event", o, e, g, a, {
                                    anonymizeIp: !0
                                });
                                else if (this.userUseGA4()) O.log("[GA] Send page event to user GA4"), "function" == typeof gtag && gtag("event", e, {
                                event_category: o,
                                event_label: g,
                                value: (0, u.default)(a),
                                ...
                                O.log("[GA] Send page event to user GA (Classic)");
                                var s = 1;
                                for (var r in l) {
                                    var c = l[r];
                                    E.push(["_setCustomVar", s, r, c, 3]), ++s
                                }
                                E.push(["_trackEvent", o, e, g, a])
                            }
                        }
                    }, {
                        ...
                        value: function() {
                            var o, e;
                            j(".s-button .s-common-button").click(("Site.button.click", o = {
                                ...
                                U.Event.publish("Site.button.click", l), e.trackPageEventOnGA("Action", o.gaEventName, l.text, null, {
                                    url: l.url,
                                    text: l.text
                                });
                                var s = "string" == typeof l.url && (0, h.default)(G).call(G, l.url, "#"),
                                    r = "string" == typeof l.url && (a[0].hostname === window.location.hostname || (0, h.default)(G).call(G, l.url, "/")),
                                    c = F.needToTriggerHelper(l.url);
                                !l.url || "_blank" === l.target || s || r || c || (g.preventDefault(), (0, f.default)((function() {
                        ...
                        value: function(o, e) {
                            var g = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
                            return this.trackUserPageEvent(T.getKeenIoPageSocialShareCollection(), {
                                user: {
                        ...
                        value: function(o) {
                            return this.trackUserPageEvent(T.getKeenIoPageFramingCollection(), {
                                user: {
                                    id: this._internals.user.id,
                                    membership: this._internals.user.membership
                                },
                        ...
                        value: function(o) {
                            var e = this;
                            return this.trackPageViewOnGA(), this.trackPageEventOnFB("PageView"), (0, f.default)((function() {
                                return e.trackPageEventOnGA("Control", "Bounce Rate")
                            }), 3e4), this.sendDataKeenIO(G.extend({}, this.baseData, o))
                        }
                    }, {
                        key: "logSocialClicks",
                        value: function(o) {
                        ...
                        value: function(o) {
                            if (this.strikinglyKeenAnalyticsEnabled) {
                                var e = G.extend({}, this.browserData, this.baseData, o);
                                return O.log("[PBS] Impression", e), S.addEvent(T.getKeenIoPbsImpressionCollection(), e)
                            }
                        }
                    }, {
                        ...
                        value: function(o) {
                            if (this.strikinglyKeenAnalyticsEnabled) {
                                var e = G.extend({}, this.browserData, this.baseData, o);
                                return O.log("[PBS] Conversion", e), S.addEvent(T.getKeenIoPbsConversionCollection(), e)
                            }
                        }
                    }, {
                        key: "trackUserPageEvent",
                        value: function(o, e) {
                            if (this.strikinglyKeenAnalyticsEnabled) return O.log("User Page Event Tracking", o, e), S.addEvent(o, e)
                        }
                    }, {
                        ...
                        value: function(o) {
                            ...
                            return this.trackUserPageEvent(T.getKeenIoEventsCollection(), m), this.trackPageEventOnGA(e, g, l, r, {
                                nonInteraction: t
                            })
                        }
                    }, {
                        ...
                        value: function(o) {
                            if (this.strikinglyKeenAnalyticsEnabled) {
                                ...
                                return T.getIsBlog() || (g = G.extend({
                                    is_multipage: D.getIsMultiPage(),
                                    page_uid: D.getCurrentPageUID()
                                }, g)), g.sharding = !0, S.addEvent($S.conf.keenio_collection, g)
                            }
                        }
                    }, {
                        ...
                        value: function(o) {
                            if (this.strikinglyKeenAnalyticsEnabled) {
                                ...
                                return O.log("File Download", e), S.addEvent(T.getKeenIoFileDownloadCollection(), e)
                            }
                        }
                    }]), o
                }();
            V.prototype.pingInterval = 1e4, G.extend(V.prototype, K), A = new V;
            var R = (0, y.default)(m = (0, _.default)(V.prototype)).call(m, (function(o) {
                    return !o.match(/^__/) && "pingInterval" !== o && "constructor" !== o
                })),
                L = [];
            if (N("stores.pageData.showCookieNotification") && -1 === (0, z.default)(i = document.cookie).call(i, "__strk_cookie_notification")) {
                var H = {};
                (0, I.default)(R).call(R, (function(o) {
                    var e = A[o];
                    H[o] = e, A[o] = function() {
                        for (var o = arguments.length, g = new Array(o), a = 0; a < o; a++) g[a] = arguments[a];
                        j.cookie("__strk_cookie_notification") ? e.apply(A, g) : L.push({
                            fn: e,
                            args: g
                        })
                    }
                })), A.enableTrackingWhenCookieIsAccepted = function() {
                    (0, I.default)(R).call(R, (function(o) {
                        A[o] = H[o]
                    })), (0, I.default)(L).call(L, (function(o) {
                        o.fn.apply(A, o.args)
                    })), L = []
                }, A.destroyTracking = function() {
                    var o = function() {
                        return null
                    };
                    (0, I.default)(R).call(R, (function(e) {
                        A[e] = o
                    })), L = []
                }
            }
