/*! For license information please see 1036.70091bbc1526aea173e9-site-bundle.js.LICENSE.txt */
        ...
        95304: function(t, e, n) {
            ...
            if (a($, {
                ...
                if ("function" == typeof E && r({
                    ...
                    var X = function(t) {
                        return l(this, X, "Request"), new O(t, arguments.length > 1 ? G(arguments[1]) : {})
                    };
                    j.constructor = X, X.prototype = j, r({
                        global: !0,
                        forced: !0
                    }, {
                        Request: X
            ...
            var r, o = n(276887),
                ...
                F = function(t, e) {
                    ...
                    if ("[" == e.charAt(0)) {
                        ...
                        for (n = "", r = h(e), o = 0; o < r.length; o++) n += X(r[o], V);
                        t.host = n
                    }
                },
                W = function(t) {
                        ...
                        switch (s = i[p], f) {
                            ...
                            case it:
                                if (s && (C.test(s) || "+" == s || "-" == s || "." == s)) d += s.toLowerCase();
                                    ...
                                    if (n && (Q(t) != l(K, d) || "file" == d && (Z(t) || null !== t.port) || "file" == t.scheme && !t.host)) return;
                            ...
                            case wt:
                                ...
                                break;
                            case _t:
                                "?" == s ? (t.query = "", f = Et) : "#" == s ? (t.fragment = "", f = Ot) : s != r && (t.path[0] += X(s, V));
                                break;
                            case Et:
                                n || "#" != s ? s != r && ("'" == s && Q(t) ? t.query += "%27" : t.query += "#" == s ? "%23" : X(s, V)) : (t.fragment = "", f = Ot);
                                break;
                            case Ot:
                                s != r && (t.fragment += X(s, J))
                        }
                        p++
                    }
                },
